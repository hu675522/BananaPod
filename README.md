...
- 20250927
  ...
  **核心功能优化与稳定性提升**
  ...
  ✅ 增加 API Key 设置功能，支持用户自定义配置
  
  ✅ 优化 API Key 存储逻辑，确保安全性和可靠性
  
  ✅ 完善 API Key 初始化流程，适配版本发布需求
...
- 20250926
  ...
  **重大优化更新 - 用户体验全面提升**
  ...
  ✅ 修复所有按钮提示没有根据当前语言显示对应的中文或英文
  
  ✅ 优化调换"English"和"中文"按钮的位置
  
  🎨 **视觉设计优化**
  
  ✅ 优化新配色方案
  
  ✅ 优化面板删除弹窗问题（对话框样式无法自定义、位置不居中，显示在浏览器默认位置、与应用整体设计风格不协调）
  
  ✅ 优化删除确认对话框样式
  
  ✅ 优化图层删除按钮弹出框内部布局，提升美观度
  
  ⚡ **功能增强**
  
  ✅ 在"锁定"、"隐藏"右边增加删除按钮，实现快速删除画出来的元素
  
  ✅ 删除按钮点击时弹出提示框，与其它删除提示框风格保持一致
