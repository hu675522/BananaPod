...
export const translations = {
  en: {
    ...
    boards: {
      ...
      deleteMessage: 'Are you sure you want to delete board',
      cannotDeleteLast: 'At least one board must remain',
      nameAlreadyExists: 'Board name already exists, please use a different name',
    },
    common: {
      cancel: 'Cancel',
      confirm: 'Confirm',
    ...
    settings: {
        ...
        getKey: 'Get your API Key from Google AI Studio',
    },
    apiKeySettings: {
        ...
        description: 'API Key will be securely stored in your browser\'s local storage.',
        getKey: 'Get API Key:',
  ...
  zho: {
    ...
    boards: {
      ...
      delete: '删除',
      deleteConfirm: '删除面板',
      deleteMessage: '确定要删除面板',
      cannotDeleteLast: '至少需要保留一个面板',
      nameAlreadyExists: '面板名称已存在，请使用其他名称',
    },
    common: {
      cancel: '取消',
      confirm: '确认',
    ...
    settings: {
        ...
        apiKey: {
            ...
            saved: 'API Key 保存成功',
            cleared: 'API Key 已清空',
            invalid: 'API Key 格式无效',
            getKey: '从 Google AI Studio 获取您的 API Key',
        },
        apiKeySettings: {
            label: 'Gemini API Key',
            placeholder: '请输入您的 Gemini API Key',
            ...
            saved: '已保存',
            cleared: '已清空',
            invalidKey: 'API Key 格式无效，应以 "AIza" 开头',
            description: '秘钥将安全地保存在您的本地存储中',
            getKey: '获取 API Key：',
